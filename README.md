...
|:-----------------------:|:-----------------------------------:|
|  `17.4.0` (`2026.6.5`)  | [v1.0.0](../../releases/tag/v1.0.0) |
...
- Inject script into APK: `objection patchapk -c objection.cfg.json -s data/build.apk -l dist/agent.js -a arm64-v8a -V 17.15.3`
- Connect your device via ADB and run `adb install -i com.android.vending build.patched.apk` to install the APK on your device. (You can also manually copy the APK to your device and install it, but this is the fastest way)
...
- Inject Frida into APK: `objection patchapk -s data/build.apk -a arm64-v8a -V 17.15.3`
- Connect your device via ADB and run `adb install -i com.android.vending build.patched.apk` to install the APK on your device. (You can also manually copy the APK to your device and install it, but this is the fastest way)
